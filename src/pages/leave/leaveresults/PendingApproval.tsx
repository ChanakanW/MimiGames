...
const rows = [
  createData(1, 'John Doe', '01/01/2024', '01/05/2024', 'Vacation', 'Jane Smith', 'Pending'),
  createData(2, 'Mary Jane', '05/01/2024', '05/03/2024', 'Sick Leave', 'Jake White', 'Pending'),
  createData(3, 'Alice Brown', '06/01/2024', '06/07/2024', 'Family Emergency', 'David Clark', 'Pending'),
  createData(4, 'Bob Black', '07/01/2024', '07/10/2024', 'Holiday', 'Emily Green', 'Pending'),
            ...
            >
              ...
              <TableCell align="right">
                <Typography
                  sx={{
                    fontWeight: 'bold',
                    color: 'orange', // Indicating pending status with orange color
                  }}
                >
                  {row.status}
                </Typography>
